...
def main():
    print(f"Initiating Expense Tracker!")
...
def get_user_expense():
    ...
    expense_categories = ["Food", "Transport", "Utilities", "Entertainment", "Other", "Home", "Work", "Health"]
...
def summarize_expenses(expense_file_path, budget):
    ...
    print(f"Here's how much you have spent for this month: {total_spent:.2f}")
    ...
    if remaining_budget < 0:
        print("Warning! You have exveeded your budget!")
